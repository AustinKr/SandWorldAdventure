...
namespace SWA::Player::Inventory
{
	Manager::Manager()
	{
		...
		StorageInventory.SetItemAt({ 1,1 }, new Items::TileItem("wet_sand_tile_slot", 0xeccc70ff, 0xc0a65aff, SWAEngine::Component::Tilemap::TileBehavior::SOLID));
		StorageInventory.SetItemAt({ 2,1 }, new Items::TileItem("sand_tile_slot", 0xffe79eff, 0xebcb68ff, SWAEngine::Component::Tilemap::TileBehavior::SAND));
		StorageInventory.SetItemAt({ 1,2 }, new Items::TileItem("water_tile_slot", 0x426dffff, 0x1147ffff, SWAEngine::Component::Tilemap::TileBehavior::FLUID));
